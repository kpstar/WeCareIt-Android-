package com.wecareit.fragments.meeting;
...
public class MeetingsFragment extends TemplateFragment {
    ...
    public static MeetingsFragment createInstance() {
                ...
                public void onResponse(Call<ArrayList<NewsResponse>> call, Response<ArrayList<NewsResponse>> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        for (NewsResponse newsres : news_me) {
                            NewsAdapter adapter = new NewsAdapter(MeetingsFragment.this.getContext(), news_me);
