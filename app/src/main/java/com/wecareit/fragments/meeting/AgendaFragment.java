...
public class AgendaFragment extends TemplateFragment {
    ...
    public static AgendaFragment createInstance() {
                ...
                public void onResponse(Call<ArrayList<NewsResponse>> call, Response<ArrayList<NewsResponse>> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        for (NewsResponse newsres : news_me) {
                            NewsAdapter adapter = new NewsAdapter(AgendaFragment.this.getContext(), news_me);
